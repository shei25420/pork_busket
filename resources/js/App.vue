    ...
    <div id="main-wrapper" class="show">
				...
				<div class="tab-content">
					<div class="tab-pane fade active show" id="chat" role="tabpanel">
						<div class="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box">
							...
							<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 853px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 734px;"></div></div></div>
						</div>
					...
					<div class="tab-pane fade" id="notes">
						<div class="card mb-sm-3 mb-md-0 note_card">
							...
							<div class="card-body contacts_body p-0 dz-scroll ps" id="DZ_W_Contacts_Body2">
								<ul class="contacts">
									<li class="active">
										<div class="d-flex bd-highlight">
											<div class="user_info">
        ...
        ***********************************-->
        ...
        <!-- <div class="deznav">
				...
				<ul class="metismenu mm-show" id="menu">
                    ...
                    <li class="mm-active"><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false" class="mm-collapse mm-show">
                            ...
                            <li class="mm-active"><a href="./ui-card.html" class="mm-active">Cards</a></li>
			...
			<div class="ps__rail-x" style="left: 0px; bottom: -759px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 759px; height: 893px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 411px; height: 482px;"></div></div></div>
        </div> -->
        <!--**********************************
            Sidebar end
        ***********************************-->
